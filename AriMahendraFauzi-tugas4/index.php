...
<body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8 text-center">
        ...
        <div class="mt-8 space-x-4">
            <!-- Button Daftar Baru -->
            <a href="daftar.php" class="inline-block mt-8 px-6 py-3 bg-green-500 text-white font-bold rounded-lg shadow-md hover:bg-green-600 transition duration-300">Daftar Baru</a>
    ...
    <script>
        // Fungsi untuk menghilangkan elemen alert setelah 2 detik
        function hideAlert() {
