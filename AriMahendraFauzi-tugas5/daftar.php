    ...
    <div class="max-w-md mx-auto">
        ...
        <form action="simpan.php" method="post" onsubmit="return validateForm()">
            ...
            <div class="flex justify-start">
                <button type="submit"
                    class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:ring focus:ring-blue-300 mx-1">Simpan</button>
                <button type="reset"
                    class="bg-gray-300 hover:bg-gray-400 text-gray-700 font-bold py-2 px-4 rounded focus:outline-none focus:ring focus:ring-gray-300 mx-1">Ulangi</button>
                <a href="index.php"
